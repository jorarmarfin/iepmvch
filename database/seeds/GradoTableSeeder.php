...
class GradoTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Grado::create(['idnivel' => $nivel->id,'ciclo' => 'I','codigo' => '1 años','nombre' => 'Inicial 1 años','activo' => true]);
        Grado::create(['idnivel' => $nivel->id,'ciclo' => 'I','codigo' => '2 años','nombre' => 'Inicial 2 años','activo' => true]);
